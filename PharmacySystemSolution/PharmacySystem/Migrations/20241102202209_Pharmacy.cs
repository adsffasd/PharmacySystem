    ...
    public partial class Pharmacy : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImpRepo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImpRepo_Supplier_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpRepo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpRepo_Product_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Account_WorkDay_WorkDayId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ImpRepoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImpRepoDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImpRepoDetail_ImpRepo_ImpRepoId",
                        column: x => x.ImpRepoId,
                        principalTable: "ImpRepo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImpRepoDetail_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpRepo_ProductId",
                table: "ExpRepo",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ImpRepo_SupplierId",
                table: "ImpRepo",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_ImpRepoDetail_ImpRepoId",
                table: "ImpRepoDetail",
                column: "ImpRepoId");

            migrationBuilder.CreateIndex(
                name: "IX_ImpRepoDetail_ProductId",
                table: "ImpRepoDetail",
                column: "ProductId");
